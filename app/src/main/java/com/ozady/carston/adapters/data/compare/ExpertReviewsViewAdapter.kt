...
class ExpertReviewsViewAdapter  (private val context: Context?) : RecyclerView.Adapter<ExpertReviewsViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_expart_cars_view , parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.apply {
            ...
            if (position%2 == 0){
                imgItem.setImageResource(R.drawable.image10)
                nameItem.text = "BMW 3 Series Sedan M Automobiles"
            }else{
                imgItem.setImageResource(R.drawable.image5)
