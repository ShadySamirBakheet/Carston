...
class CompareCarAdapter (private val context: Context?) : RecyclerView.Adapter<CompareCarAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_compare_car , parent, false)
