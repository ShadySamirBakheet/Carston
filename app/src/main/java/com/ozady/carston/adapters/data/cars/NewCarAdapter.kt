...
class NewCarAdapter (private val context: Context?) : RecyclerView.Adapter<NewCarAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_new_car , parent, false)
